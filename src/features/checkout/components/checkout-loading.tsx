  ...
  return (
    <section className="relative flex h-full min-h-dvh flex-col items-start justify-center lg:h-dvh lg:flex-row lg:overflow-hidden">
      <div className="w-full space-y-12 pt-8 lg:pt-16">
        ...
        <div className="container flex max-w-xl flex-col items-center space-y-1.5 lg:mr-0 lg:ml-auto lg:items-start lg:pr-[4.5rem]">
          <Skeleton className="h-6 w-28" />
          <Skeleton className="h-8 w-36" />
        </div>
        <ScrollArea className="h-full">
          <div className="container hidden w-full max-w-xl flex-col gap-5 lg:mr-0 lg:ml-auto lg:flex lg:max-h-[580px] lg:pr-[4.5rem]">
      ...
      <div className="size-full flex-1 bg-white pt-10 pb-12 lg:flex-initial lg:pt-16 lg:pl-12">
        <ScrollArea className="h-full">
          <div className="container grid max-w-xl gap-5 lg:mr-auto lg:ml-0">
            ...
            <div className="flex xxs:flex-row flex-col items-center gap-2">
